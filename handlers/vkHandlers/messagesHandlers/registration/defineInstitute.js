...
module.exports = async id => {
  ...
  const msg = `Добро пожаловать, ${first_name}! Прежде всего мне нужно определить, в какой группе ты учишься. Для начала выбери название своего института, используя кнопки ниже.`;
